...
#from .COMPONENTS.FileHandling import load_user_settings, read_default_molecule_parameters, read_initial_molecule_parameters, read_save_data, read_HITRAN_data, read_from_user_csv, read_default_csv, read_spectral_data
...
'''from .COMPONENTS.DataProcessing.slabfit import *
...
class iSLATGUI:
    """
    iSLATGUI class to handle the iSLAT graphical user interface.
    This class is used to initialize the GUI components and manage user interactions.
    Will also use the Data processing to handle plot updates and other GUI-related tasks.
    """

    def __init__(self):
        #self.islat = islat_instance
        self.root = None  # Will be initialized in init_gui()

class iSLATData:
    def __init__(self, islat_instance):
        self.islat = islat_instance
        self.molecules_dict = None  # Will be initialized in init_molecules()
        self.wave_data = None
        self.flux_data = None

'''class iSLAT:
    def __init__(self):
        self.GUI = iSLATGUI(self)
        self.data = iSLATData(self)'''
